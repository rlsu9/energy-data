...
TR_EARLY_NIGHT = (localtime(20), localtime(22))
TR_ALL_DAY = (localtime(0), localtime(23, 59))
...
class TestCarbonIntensity:
    @pytest.mark.parametrize('location, iso, timerange, expected_carbon_intensity_range', [
        ...
        ('UCSD', 'US-CAISO', TR_EARLY_NIGHT, (250, 350)),  # No solar during nighttime
        ('Milwaukee, WI', 'US-MISO', TR_ALL_DAY, (300, None)),  # All-day coal
        ('Columbus, OH', 'US-PJM', TR_ALL_DAY, (300, None)),  # All-day coal
        ('Boardman, OR', 'US-BPA', TR_ALL_DAY, (None, 60)),  # All-day hydro
        ('Austin, TX', 'US-ERCOT', (localtime(0, 0, date(2022, 6, 1)),
                                    localtime(23, 59, date(2022, 6, 1))), (300, 400)),  # Relative stable in ERCOT
    ])
    def test_carbon_intensity_in_rough_range(self, location, iso, timerange, expected_carbon_intensity_range, client,
                                             get_gps_coordinate):

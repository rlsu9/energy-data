...
GENERATION_MAPPING = {'Wind': 'wind',
                      ...
                      'Nuclear': 'nuclear',
                      'VER': 'wind/solar'}
# Note: See VER definition on https://transmission.bpa.gov/Business/Operations/Wind/
# This page also has historic data from 2007, under item 5 in the list.
...
def data_processor(df, logger) -> list:
    ...
    # 5min data for the last two days.
    df = df.tail(2 * 24 * 60 // 5)
